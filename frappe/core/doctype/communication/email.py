...
def make(doctype=None, name=None, content=None, subject=None, sent_or_received = "Sent",
	...
	flags=None,read_receipt=None, print_letterhead=True,print_options=None):
...
def notify(doc, print_html=None, print_format=None, attachments=None,
	...
	if frappe.flags.in_test:
		...
		enqueue(sendmail, queue="default", timeout=300, event="sendmail",
			...
			session=frappe.local.session, print_letterhead=frappe.flags.print_letterhead,print_options = print_options)
...
def sendmail(communication_name, print_html=None, print_format=None, attachments=None,
	recipients=None, cc=None, bcc=None, lang=None, session=None, print_letterhead=None ,print_options = None):
