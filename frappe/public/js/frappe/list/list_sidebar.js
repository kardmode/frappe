...
frappe.views.ListSidebar = class ListSidebar {
	...
	make() {
		...
		this.sidebar = $('<div class="list-sidebar overlay-rightbar hide"></div>')
	...
	setup_email_inbox() {
		...
		accounts.forEach((account) => {
			...
			$(`<li class="list-sidebar-item"><a class="list-sidebar-link" href="#${route}">${display_name}</a></li>`).appendTo($dropdown);
