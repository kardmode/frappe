...
def get_print(doctype=None, name=None, print_format=None, style=None, html=None, as_pdf=False, doc=None, output = None,no_letterhead = 0,options=None,letterhead = None,sign_type=None):
