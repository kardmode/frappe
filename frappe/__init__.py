...
def get_print(doctype=None, name=None, print_format=None, style=None, html=None, as_pdf=False, doc=None, output = None,options=None,letterhead = None,sign_type=None):
